...
class MonodepthDataloader(object):
    ...
    def __init__(self, data_path, filenames, params, dataset, mode, num_views):
        ...
        if mode == 'test' and not self.params.do_stereo:
            ...
            left_image_o, right_image_o = self.read_and_decode(filename_queue)
    ...
    def read_and_decode(self, filename_queue):
        ...
        left_image = tf.decode_raw(features['left'], tf.uint8)
        right_image = tf.decode_raw(features['right'], tf.uint8)
